...
<div class="wrap">
	...
	<h2><?php _e( 'Manage Extensions', SOCME ); ?> <a href="http://pixeljar.net" target="_blank" title="<?php _e( 'Browse Extensions', SOCME ); ?>" class="button add-new-h2"><?php _e( 'Browse Extensions', SOCME ); ?></a>
